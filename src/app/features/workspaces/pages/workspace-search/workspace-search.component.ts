...
export class WorkspaceSearchComponent implements OnInit, OnDestroy {
  ...
  constructor(private readonly notesApi: NotesApiService, private readonly authService: AuthService) {}
